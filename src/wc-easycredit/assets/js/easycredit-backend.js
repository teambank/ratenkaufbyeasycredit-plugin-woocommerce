jQuery(function($){
    ...
    var prefix = 'wc_easycredit_';
    var getBaseUrl = function(action) {
        return wc_easycredit_config.url+'?action='+prefix+action;
    }

    $('#woocommerce_easycredit_api_verify_credentials').click(function(){
        let button = $(this);
        button.prop('disabled', true);
        var apiKey = $('#woocommerce_easycredit_api_key').val();
        var apiToken = $('#woocommerce_easycredit_api_token').val();
        var apiSignature = $('#woocommerce_easycredit_api_signature').val();
